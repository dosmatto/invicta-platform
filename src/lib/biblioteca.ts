...
export const CATEGORIAS: DefCategoria[] = [
  ...
  { slug: 'analises-foliares', nome: 'Análises Foliares', icone: Salad, status: 'disponivel',
    descricao: 'Normas DRIS/CND e faixas de suficiência foliar por cultura, órgão e estádio. Literatura embarcada ou geradas a partir dos seus laudos e mapas de colheita.' },
