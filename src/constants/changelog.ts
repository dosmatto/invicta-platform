...
export const CHANGELOG: Record<string, string[]> = {
  ...
  '2.153.0': [
    ...
    'Verificação: teste:foliar 55/55, teste:foliar-normas 30/30, teste:foliar-fabrica 9/9, teste:foliar-graficos 9/9, teste:foliar-importacao 22/22, teste:lab 43/43, teste:portal 30/30, npx tsc --noEmit limpo e npm run build de produção passou (commit d0821ac).',
  ],
