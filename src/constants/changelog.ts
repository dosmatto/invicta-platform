...
export const CHANGELOG: Record<string, string[]> = {
  ...
  '2.153.0': [
    ...
    'QUATRO MÉTODOS RODAM LADO A LADO, NÃO UM SÓ. DRIS (com as quatro funções f da literatura — Alvarez-Leite, Jones, Beaufils e a variante robusta), CND (distância multivariada de Mahalanobis sobre a transformação clr), faixa de suficiência (o mínimo–máximo clássico) e chance matemática (a frequência do teor na população de alta produtividade). Os quatro são calculados sobre a MESMA amostra e apresentados juntos, com uma MATRIZ DE CONCORDÂNCIA mostrando onde os métodos concordam e onde divergem — divergência é informação, não seria honesto escondê-la atrás de um número só.',
    ...
    'RELATÓRIO EM PDF, individual (um talhão, uma safra) e em lote (vários talhões de uma vez), com os quatro métodos, a matriz de concordância e a ordem de limitação — o mesmo que a tela mostra, para o produtor levar impresso.',
    ...
    'Verificação: teste:foliar 46/46, teste:foliar-normas 25/25, teste:foliar-fabrica 9/9, teste:foliar-graficos 9/9, teste:foliar-importacao 22/22, teste:lab 43/43, teste:portal 30/30, npx tsc --noEmit limpo. npm run build não foi executado nesta sessão de fechamento (ledger pede para pular; validado na íntegra na integração final antes do push).',
  ],
