...
export const CHANGELOG: Record<string, string[]> = {
  '2.32.1': [
    'O MAPA DO RELATÓRIO DA EQUAÇÃO VOLTOU A OBEDECER À LEGENDA. Editar as faixas e as cores em Biblioteca → Equações → "Estilo do mapa" mudava o mapa na TELA, mas o mapa do PDF continuava com a legenda antiga — para sempre, por mais que se editasse. Relatado na equação "KCL para 3% na CTC + 220 Kg".',
    'A CAUSA: o cenário salvo guardava uma FOTOGRAFIA da legenda, tirada na hora em que a dose foi processada, e nenhum relatório voltava a ler a equação. Dava para desconfiar por um detalhe: mudar o NÚMERO da equação aparecia no PDF na hora; mudar as FAIXAS, nunca — mesma tela de edição, comportamentos opostos.',
    'AGORA A LEGENDA É VIVA: o cenário continua guardando o mapa calculado (que é resultado e não muda), mas as faixas, as cores, o nome da equação e o produto vêm da Biblioteca no momento de abrir. Vale para o PDF oficial, o relatório combinado, o relatório da fazenda, o JPG, o shapefile e o "reabrir" na tela — sem reprocessar nada. Se a equação tiver sido excluída, o mapa continua saindo com a legenda guardada: nada deixa de gerar.',
    'O QUE NÃO ACOMPANHA: a dose de cada ponto do mapa, a dose mínima e os custos (R$/t, frete, aplicação). São o RESULTADO daquele processamento — trocá-los sem recalcular faria o financeiro do relatório não bater com o mapa. Para atualizar dose ou custo, reprocesse em Recomendações.',
    'CONSEQUÊNCIA A SABER: regerar um PDF antigo agora sai com as cores novas, e um shapefile re-exportado traz o campo CLASSE nos limites novos (a TAXA, que é a dose real de cada ponto, não muda). Se você precisa da folha exatamente como foi entregue ao cliente, guarde o arquivo — o app passa a refletir a legenda de hoje.',
    '12 testes novos (npm run teste:faixas, 21 no total) travam a regra: passadas de aplicação herdam a legenda da equação-mãe, renomear preserva o "— aplicação 2/3", equação excluída cai na legenda guardada, e dose mínima e custos ficam intactos.',
  ],
  '2.32.0': [
