...
export const CHANGELOG: Record<string, string[]> = {
  ...
  '2.153.0': [
    ...
    'A REGRA QUE ATRAVESSA O MÓDULO INTEIRO: SEM NORMA, SEM NÚMERO. DRIS e CND só rodam quando existe norma cadastrada para aquela cultura E aquele órgão da planta — sem isso o método fica null com o motivo declarado, nunca um índice inventado. E um laudo incompleto (faltando nutriente que a norma exige) não roda CND: a distância de Mahalanobis exige o conjunto fechado de componentes, misturar amostra incompleta com norma completa daria um número sem significado.',
    'Verificação: teste:foliar 46/46, teste:foliar-normas 25/25, teste:foliar-fabrica 9/9, teste:foliar-graficos 9/9, teste:foliar-importacao 22/22, teste:lab 43/43, teste:portal 30/30, npx tsc --noEmit limpo e npm run build de produção passou (commit d0821ac).',
  ],
