...
export const CHANGELOG: Record<string, string[]> = {
  '2.33.0': [
    ...
    'Onde ver: Talhão → aba Relatórios → Gerar (cabeçalho de cada página de mapa) e o PDF de Zonas de Manejo. As siglas, nomes e unidades ficam em Biblioteca → Preferências de Análise → Variáveis de Análise.',
  ],
  '2.32.0': [
